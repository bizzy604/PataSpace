            ...
            <Card className="border border-border bg-card shadow-sm">
              ...
              <CardContent className="grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div key={title} className="rounded-xl bg-muted/50 p-5">
            ...
            <Card className="border border-border bg-card shadow-sm">
              ...
              <CardContent className="space-y-4">
                {supportTopics.map((topic) => (
                  <div key={topic.title} className="rounded-lg bg-muted/50 p-5">
          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 bg-gradient-to-br from-primary to-accent text-primary-foreground shadow-lg">
              <CardHeader>
                ...
                <CardDescription className="text-sm leading-7 text-primary-foreground/70">
              ...
              <CardContent className="space-y-4">
                {tickets.length === 0 ? (
                  ...
                  tickets.map((ticket) => (
                    <div
                      key={ticket.id}
                      className="rounded-lg bg-primary-foreground/10 p-4 text-sm leading-7 text-primary-foreground/80"
                    >
                      <div className="flex items-center justify-between gap-3">
                        <p className="font-medium text-primary-foreground">{ticket.subject}</p>
    ...
    <PublicSiteFrame>
      <section className="px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-xl border border-border bg-card p-8 shadow-sm">
          <p className="inline-flex rounded-full border border-primary/15 bg-primary/5 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-primary">
            What's new
          </p>
